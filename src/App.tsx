...
type Screen = 'splash' | 'login' | 'step1' | 'step2' | 'step3' | 'status' | 'dashboard' | 'transactions' | 'profile' | 'notifications' | 'map';
...
export default function App() {
  ...
  const [notifications, setNotifications] = useState([
    { id: 1, title: 'তেল সংগ্রহ সফল', message: 'আপনি ২.৫ লিটার অকটেন সংগ্রহ করেছেন পদ্মা অয়েল কোম্পানি থেকে।', time: '১০ মিনিট আগে', unread: true, type: 'success' },
    { id: 2, title: 'লিমিট আপডেট', message: 'আপনার আজকের তেলের লিমিট ৫ লিটার থেকে বাড়িয়ে ৭ লিটার করা হয়েছে।', time: '২ ঘণ্টা আগে', unread: true, type: 'info' },
    { id: 3, title: 'পেমেন্ট রিসিভড', message: '৩৩৭.৫০ টাকা পেমেন্ট সফলভাবে সম্পন্ন হয়েছে।', time: '৫ ঘণ্টা আগে', unread: false, type: 'payment' },
    { id: 4, title: 'নিরাপত্তা সতর্কতা', message: 'আপনার প্রোফাইল তথ্য সফলভাবে যাচাই করা হয়েছে।', time: '১ দিন আগে', unread: false, type: 'security' },
    { id: 5, title: 'স্বাগতম!', message: 'ফুয়েল পাস অ্যাপে আপনাকে স্বাগতম। আপনার ডিজিটাল ফুয়েল যাত্রা শুরু করুন।', time: '২ দিন আগে', unread: false, type: 'info' }
  ]);
  ...
  const [userRole, setUserRole] = useState<'owner' | 'operator'>('owner'); // Selection for login
  const [userRoleActual, setUserRoleActual] = useState<'owner' | 'operator'>('owner'); // Actual logged in role
  ...
  const handleRegisterVehicle = async () => {
    if (!regDistrict || !regSeries || !regNumber || !regModel || !regColor || !regEngineNumber) {
  ...
  const pumps = [
    { id: 1, name: 'পদ্মা ফিলিং স্টেশন', location: 'কারওয়ান বাজার, ঢাকা', distance: '০.৮ কিমি', status: 'খোলা', octane: 'আছে', diesel: 'আছে', petrol: 'নাই', lat: 40, lng: 30 },
    { id: 2, name: 'মেঘনা পেট্রোলিয়াম', location: 'উত্তরা সেক্টর-৪, ঢাকা', distance: '১.৫ কিমি', status: 'খোলা', octane: 'আছে', diesel: 'আছে', petrol: 'আছে', lat: 60, lng: 50 },
    { id: 3, name: 'যমুনা অয়েল লিমিটেড', location: 'বনানী, ঢাকা', distance: '২.২ কিমি', status: 'ভিড় বেশি', octane: 'নাই', diesel: 'আছে', petrol: 'আছে', lat: 25, lng: 70 },
    { id: 4, name: 'ট্রাস্ট ফিলিং স্টেশন', location: 'সাভার, ঢাকা', distance: '৪.৫ কিমি', status: 'বন্ধ', octane: 'নাই', diesel: 'নাই', petrol: 'নাই', lat: 75, lng: 20 }
  ];

  const transactions = [
    { company: 'পদ্মা অয়েল কোম্পানি', date: '২০ মার্চ ২০২৬', time: '১১:৪৫ AM', amount: '২.৫ লিটার', price: '৩৩৭.৫০ টাকা', method: 'নগদ', location: 'কারওয়ান বাজার, ঢাকা' },
    { company: 'মেঘনা পেট্রোলিয়াম', date: '১৮ মার্চ ২০২৬', time: '০৯:৩০ AM', amount: '৩.০ লিটার', price: '৪০৫.০০ টাকা', method: 'কার্ড', location: 'উত্তরা সেক্টর-৪, ঢাকা' },
    { company: 'যমুনা অয়েল লিমিটেড', date: '১৫ মার্চ ২০২৬', time: '০৪:১৫ PM', amount: '১.৫ লিটার', price: '২০২.৫০ টাকা', method: 'বিকাশ', location: 'বনানী, ঢাকা' },
    { company: 'পদ্মা অয়েল কোম্পানি', date: '১২ মার্চ ২০২৬', time: '০৮:২০ AM', amount: '৪.০ লিটার', price: '৫৪০.০০ টাকা', method: 'নগদ', location: 'ধানমন্ডি, ঢাকা' },
    { company: 'মেঘনা পেট্রোলিয়াম', date: '১০ মার্চ ২০২৬', time: '০৭:১০ PM', amount: '২.০ লিটার', price: '২৭০.০০ টাকা', method: 'কার্ড', location: 'মিরপুর-১০, ঢাকা' }
  ];
  ...
  const renderSplashScreen = () => (
    <div className="relative flex min-h-screen w-full flex-col justify-between overflow-hidden bg-surface">
      ...
      <div className="relative w-full px-6 pb-12 pt-20 z-10">
        <div className="absolute bottom-0 left-0 right-0 -z-10 h-full w-full opacity-10" 
             style={{ background: 'radial-gradient(circle at bottom center, var(--color-primary) 0%, transparent 70%)' }}>
        </div>
        ...
        <div className="mt-8 flex justify-center">
          <span className="text-xs font-bold uppercase tracking-widest text-secondary opacity-40">Ver 2.4.0 • Secured</span>
        </div>
      </div>
    ...
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md border-b border-[#bec9c2]/15 h-16 flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <button onClick={() => setScreen('splash')} className="active:scale-95 duration-200 text-[#00503a] hover:bg-[#eeeeee] p-2 rounded-full transition-colors">
            <ArrowLeft size={24} />
          </button>
      ...
      <main className="flex-grow pt-24 pb-12 px-6 max-w-2xl mx-auto w-full">
        <div className="mb-10 text-center">
          ...
          <h2 className="text-3xl font-bold text-primary mb-2">ব্যক্তিগত তথ্য</h2>
          <p className="text-secondary text-sm leading-relaxed">আপনার সঠিক তথ্য প্রদান করে ফুয়েল পাস নিবন্ধন সম্পন্ন করুন</p>
        </div>
        ...
        <div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_4px_24px_rgba(0,33,22,0.06)] border border-outline-variant/10">
          <div className="space-y-8">
            <div className="group">
              <label htmlFor="reg-name" className="block text-secondary font-medium text-sm mb-2 px-1">পূর্ণ নাম</label>
              <input 
                id="reg-name"
                name="fullName"
                autoComplete="name"
            ...
            <div className="group">
              <label htmlFor="reg-mobile" className="block text-secondary font-medium text-sm mb-2 px-1">মোবাইল নম্বর</label>
              <div className="relative">
                <span className="absolute left-4 top-1/2 -translate-y-1/2 text-secondary font-semibold">+৮৮</span>
                <input 
                  id="reg-mobile"
                  name="mobile"
            ...
            <div className="group">
              <label htmlFor="reg-email" className="block text-secondary font-medium text-sm mb-2 px-1">ই-মেইল (অপশনাল)</label>
              <div className="relative">
                <input 
                  id="reg-email"
                  name="email"
            ...
            <div className="group">
              <label htmlFor="reg-password" className="block text-secondary font-medium text-sm mb-2 px-1">পাসওয়ার্ড (কমপক্ষে ৬ ডিজিট)</label>
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full bg-surface-container-low border-b-2 border-outline-variant focus:border-primary focus:ring-0 pl-12 pr-4 py-3.5 transition-all outline-none rounded-t-lg placeholder:opacity-50 font-medium" 
            ...
            <div className="flex items-start gap-3 bg-surface-container p-4 rounded-lg">
              <ShieldCheck className="text-primary-container shrink-0 mt-0.5" size={20} />
              <p className="text-xs text-on-surface-variant leading-relaxed">
                আপনার ব্যক্তিগত তথ্য নিরাপদে সংরক্ষিত থাকবে। আমরা আপনার গোপনীয়তা রক্ষা করতে প্রতিশ্রুতিবদ্ধ।
              </p>
            </div>
        ...
        <div className="mt-12 overflow-hidden rounded-2xl h-48 relative">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-primary/40 to-transparent flex items-center p-8">
            <div className="text-white max-w-[200px]">
              ...
              <p className="text-xs opacity-80">আপনার সকল তথ্য এনক্রিপ্ট করা পদ্ধতিতে সংরক্ষিত থাকে।</p>
            </div>
          </div>
        </div>
      </main>
  ...
  const renderStep2 = () => (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md border-b border-[#bec9c2]/15 flex items-center justify-between px-6 h-16">
        <div className="flex items-center gap-4">
          <button onClick={() => setScreen('step1')} className="text-[#00503a] active:scale-95 duration-200 p-2 rounded-full hover:bg-[#eeeeee] transition-colors">
            <ArrowLeft size={24} />
          </button>
      ...
      <main className="flex-grow pt-24 pb-32 px-6 max-w-2xl mx-auto w-full">
        <div className="mb-10">
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-2xl font-semibold text-primary">গাড়ির বিস্তারিত তথ্য</h2>
          </div>
        ...
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              ...
              >
                <Bike className={`mb-2 ${vehicleType === 'bike' ? 'text-primary' : 'text-secondary group-hover:text-primary'}`} size={32} />
                <span className={`text-sm ${vehicleType === 'bike' ? 'font-bold text-primary' : 'font-medium'}`}>বাইক</span>
                {vehicleType === 'bike' && <CheckCircle2 className="absolute top-2 right-2 text-primary" size={12} />}
              </button>
              <button 
              ...
              >
                <Car className={`mb-2 ${vehicleType === 'car' ? 'text-primary' : 'text-secondary group-hover:text-primary'}`} size={32} />
                <span className={`text-sm ${vehicleType === 'car' ? 'font-bold text-primary' : 'font-medium'}`}>কার</span>
                {vehicleType === 'car' && <CheckCircle2 className="absolute top-2 right-2 text-primary" size={12} />}
              </button>
              <button 
              ...
              >
                <Truck className={`mb-2 ${vehicleType === 'truck' ? 'text-primary' : 'text-secondary group-hover:text-primary'}`} size={32} />
                <span className={`text-sm ${vehicleType === 'truck' ? 'font-bold text-primary' : 'font-medium'}`}>ট্রাক</span>
                {vehicleType === 'truck' && <CheckCircle2 className="absolute top-2 right-2 text-primary" size={12} />}
              </button>
            </div>
          </div>
            ...
            <div className="grid grid-cols-12 gap-3">
              <div className="col-span-5 relative">
                ...
                >
                  ...
                  {[
                    'ঢাকা মেট্রো', 'গাজীপুর', 'নারায়ণগঞ্জ', 'নরসিংদী', 'মুন্সিগঞ্জ', 'মানিকগঞ্জ', 'টাঙ্গাইল', 'কিশোরগঞ্জ', 'মাদারীপুর', 'গোপালগঞ্জ', 'শরীয়তপুর', 'ফরিদপুর', 'রাজবাড়ী', 'চট্টগ্রাম মেট্রো', 'কক্সবাজার', 'কুমিল্লা', 'ব্রাহ্মণবাড়িয়া', 'চাঁদপুর', 'ফেনী', 'লক্ষ্মীপুর', 'নোয়াখালী', 'খাগড়াছড়ি', 'রাঙ্গামাটি', 'বান্দরবান', 'রাজশাহী মেট্রো', 'নাটোর', 'নওগাঁ', 'চাঁপাইনবাবগঞ্জ', 'পাবনা', 'সিরাজগঞ্জ', 'বগুড়া', 'জয়পুরহাট', 'খুলনা মেট্রো', 'বাগেরহাট', 'সাতক্ষীরা', 'যশোর', 'নড়াইল', 'মাগুরা', 'ঝিনাইদহ', 'কুষ্টিয়া', 'মেহেরপুর', 'চুয়াডাঙ্গা', 'বরিশাল', 'ভোলা', 'পটুয়াখালী', 'পিরোজপুর', 'ঝালকাঠি', 'বরগুনা', 'সিলেট', 'মৌলভীবাজার', 'হবিগঞ্জ', 'সুনামগঞ্জ', 'রংপুর', 'গাইবান্ধা', 'কুড়িগ্রাম', 'লালমনিরহাট', 'নীলফামারী', 'পঞ্চগড়', 'ঠাকুরগাঁও', 'দিনাজপুর', 'ময়মনসিংহ', 'জামালপুর', 'শেরপুর', 'নেত্রকোনা'
                  ].map(district => (
                    <option key={district} value={district}>{district}</option>
                  ))}
                </select>
                <ChevronDown className="absolute right-3 top-5 text-outline/30 pointer-events-none" size={16} />
              </div>
              <div className="col-span-3 relative">
                ...
                >
                  ...
                  {['ক', 'খ', 'গ', 'ঘ', 'ঙ', 'চ', 'ছ', 'জ', 'ঝ', 'ঞ', 'ট', 'ঠ', 'ড', 'ঢ', 'ণ', 'ত', 'থ', 'দ', 'ধ', 'ন', 'প', 'ফ', 'ব', 'ভ', 'ম', 'য', 'র', 'ল', 'শ', 'ষ', 'স', 'হ'].map(s => (
          ...
          <div className="mt-8 p-6 bg-surface-container-low rounded-2xl flex items-center gap-6 overflow-hidden">
            <div className="flex-1">
              ...
              <p className="text-sm text-secondary leading-relaxed">আপনার প্রদানকৃত তথ্য ডিজিটাল ফুয়েল পাসের কিউআর কোডে যুক্ত হবে। ভুল তথ্য দিলে পাম্পে সমস্যা হতে পারে।</p>
            </div>
        ...
        <div className="mt-12 flex flex-col gap-4">
          ...
          <p className="text-center text-secondary text-sm">আপনি চাইলে পরবর্তীতে এই তথ্য পরিবর্তন করতে পারবেন</p>
        </div>
      </main>
    </div>
  );
  ...
  const renderStep3 = () => (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md border-b border-[#bec9c2]/15 h-16 flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <button onClick={() => setScreen('step2')} className="text-[#00503a] active:scale-95 duration-200 p-2 hover:bg-[#eeeeee] rounded-full transition-colors">
            <ArrowLeft size={24} />
          </button>
          <h1 className="font-bold text-lg text-[#00503a]">ফুয়েল পাস</h1>
        </div>
      ...
      <main className="flex-grow pt-24 pb-32 px-6 max-w-2xl mx-auto w-full">
        ...
        <input 
          ...
          onChange={(e) => {
            ...
            if (file) {
              setCarFile(file);
              setCapturedImages(prev => ({ ...prev, car: URL.createObjectURL(file) }));
            }
          }}
        />
        <input 
          ...
          onChange={(e) => {
            ...
            if (file) {
              setPlateFile(file);
              setCapturedImages(prev => ({ ...prev, plate: URL.createObjectURL(file) }));
            }
          }}
        />
        <input 
          ...
          onChange={(e) => {
            ...
            if (file) {
              ...
              setCapturedImages(prev => ({ ...prev, bluebook: URL.createObjectURL(file) }));
            }
          }}
        />
        ...
        <div className="mb-8">
          <div className="flex justify-between items-end mb-2">
            <h2 className="text-2xl font-bold text-primary leading-tight">ভেরিফিকেশন ও ছবি আপলোড</h2>
        ...
        <div className="mb-8 p-4 bg-surface-container-low rounded-xl border-l-4 border-primary">
          <p className="text-on-surface-variant text-sm leading-relaxed">
            সঠিক ভেরিফিকেশনের জন্য নিচের ছবিগুলো পরিষ্কারভাবে তুলুন। আপলোড করা প্রতিটি ছবি আমাদের সিস্টেম দ্বারা যাচাই করা হবে।
          </p>
        </div>
          ...
          <div className="md:col-span-2 group relative bg-surface-container-lowest rounded-xl p-6 transition-all duration-200 active:scale-[0.98] outline outline-1 outline-outline-variant/15">
            <div className="flex flex-col md:flex-row gap-6 items-center">
              <div className="w-full md:w-48 h-32 rounded-lg bg-surface-container flex items-center justify-center relative overflow-hidden">
                {capturedImages.car ? (
                  <img src={capturedImages.car} className="absolute inset-0 w-full h-full object-cover" />
                ) : (
                  <>
                    <img 
              ...
              <div className="flex-grow text-center md:text-left">
                <h3 className="text-lg font-bold text-primary mb-1">গাড়ির ছবি</h3>
                <p className="text-sm text-secondary leading-relaxed">গাড়ির মডেল এবং রঙ পরিষ্কারভাবে দেখা যায় এমন একটি ফুল বডি ছবি তুলুন।</p>
                <button 
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-secondary-container/30 flex items-center justify-center mb-4 overflow-hidden">
                {capturedImages.plate ? (
                  <img src={capturedImages.plate} className="w-full h-full object-cover" />
                ) : (
                  <Hash className="text-secondary" size={32} />
                )}
              </div>
              <h3 className="text-md font-bold text-primary mb-2">নম্বর প্লেটের ছবি</h3>
              <p className="text-xs text-secondary mb-4">OCR ভেরিফিকেশনের জন্য নম্বরগুলো স্পষ্টভাবে তুলুন।</p>
              <button 
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-20 h-20 rounded-full bg-secondary-container/30 flex items-center justify-center mb-4 overflow-hidden">
                {capturedImages.bluebook ? (
                  <img src={capturedImages.bluebook} className="w-full h-full object-cover" />
                ) : (
                  <BookOpen className="text-secondary" size={32} />
                )}
              </div>
              <h3 className="text-md font-bold text-primary mb-2">ব্লু-বুক ছবি</h3>
              <p className="text-xs text-secondary mb-4">রেজিস্ট্রেশন কাগজের প্রথম পৃষ্ঠার একটি স্পষ্ট ছবি।</p>
              <button 
        ...
        <div className="mt-12 flex items-start gap-3 p-4 bg-red-50 rounded-xl border border-red-100">
          ...
          <p className="text-sm text-on-surface-variant font-medium leading-relaxed">
            আপনার তথ্যগুলো পাম্পে তেল প্রদানের সময় যাচাই করা হবে। ভুল তথ্য প্রদান করলে সার্ভিসটি বাতিল হতে পারে।
          </p>
        </div>
      </main>
      ...
      <footer className="fixed bottom-0 w-full bg-surface-container-lowest p-6 border-t border-outline-variant/10 z-50">
        <div className="max-w-2xl mx-auto">
          ...
          >
            {isUploadingImages ? 'ছবি আপলোড হচ্ছে...' : 'রেজিস্ট্রেশন সম্পন্ন করুন'}
          </button>
        </div>
      </footer>
    </div>
  ...
  const renderStatus = () => (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md border-b border-[#bec9c2]/15 flex items-center justify-between px-6 h-16">
        <div className="flex items-center gap-4">
          <button onClick={() => setScreen('splash')} className="text-[#00503a] active:scale-95 duration-200 hover:bg-[#eeeeee] p-2 rounded-full transition-colors">
            <ArrowLeft size={24} />
          </button>
          <h1 className="font-bold text-lg text-[#00503a]">রেজিস্ট্রেশন স্ট্যাটাস</h1>
        </div>
      ...
      <main className="flex-grow pt-24 pb-12 px-6 flex flex-col items-center max-w-2xl mx-auto w-full">
        <div className="flex flex-col items-center text-center mb-12">
          ...
          <h2 className="text-2xl font-semibold text-primary mb-4 leading-relaxed">আপনার তথ্য জমা হয়েছে।</h2>
          <p className="text-secondary text-lg max-w-xs leading-[1.6]">ভেরিফিকেশন সম্পন্ন হলে আপনাকে জানিয়ে দেওয়া হবে</p>
        </div>
          ...
          <div className="bg-surface-container-lowest rounded-xl overflow-hidden editorial-shadow border border-outline-variant/10">
            ...
            <div className="p-6 flex flex-col md:flex-row gap-6">
              ...
              <div className="w-full md:w-1/2 flex flex-col justify-center">
                <div className="mb-6">
                  <label className="text-secondary text-xs font-bold uppercase tracking-wider mb-1 block">গাড়ির ধরণ</label>
                  <p className="text-on-surface text-xl font-medium">
                    {vehicleType === 'bike' ? 'মোটরসাইকেল' : vehicleType === 'car' ? 'ব্যক্তিগত গাড়ি' : 'ট্রাক'}
                  </p>
                </div>
                <div className="border-l-4 border-primary pl-4">
                  <label className="text-secondary text-xs font-bold uppercase tracking-wider mb-1 block">লাইসেন্স প্লেট নম্বর</label>
            ...
            <div className="bg-surface-container-low px-6 py-4 flex items-start gap-3">
              ...
              <p className="text-on-secondary-container text-sm leading-relaxed">
                আমাদের প্রতিনিধি ২৪ ঘণ্টার মধ্যে আপনার প্রদত্ত তথ্যাদি যাচাই করবেন। সঠিক তথ্য না থাকলে আবেদনটি বাতিল হতে পারে।
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="mt-auto py-8 text-center text-secondary opacity-50">
        <p className="text-xs">© ২০২৪ ফুয়েল পাস । গণপ্রজাতন্ত্রী বাংলাদেশ সরকার কর্তৃক অনুমোদিত</p>
      </footer>
    </div>
  );
  ...
  const renderDashboard = () => (
    <div className="bg-surface text-on-surface font-body leading-relaxed antialiased min-h-screen">
        ...
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-primary-container overflow-hidden border-2 border-primary-fixed">
            <img 
              alt="User profile" 
              className="w-full h-full object-cover"
              src={capturedImages.car || "https://lh3.googleusercontent.com/aida-public/AB6AXuBDBMerF8ZIdHnF8uLDe0rcQhGaKZhvyUavAyflVc_b4K9dZqS3nLuHXh78O2EohWbIR5-Kw8tPzyDqwTRBeH7XC3d0rai6HlOE2jaEIThAvCFL7ipXyXdxZ3l35TYmxlElzFlPJXGAaX5I0Pml1Ii4jWlgRctx6BAH07YN4gt4m_TkBBjmlvz8JzYQ53kYbfc6BExhQfoZJPAU6Q6A017_BYL5_Wz-Y-c3T67_2F3OA6Z6E75ADa9JkmYYT7kOaEtrLr77JerAOUHw"}
            />
          </div>
          <h1 className="text-[#00503a] font-bold text-xl tracking-tight">ফুয়েল পাস</h1>
        </div>
        <button 
      ...
      <main className="pt-24 pb-32 px-5 max-w-md mx-auto space-y-8">
        <section>
          <h2 className="text-secondary text-sm font-bold mb-4 px-1">আজকের তেলের দর</h2>
          <div className="flex gap-4 overflow-x-auto pb-2 scrollbar-hide">
            {(dashboardData?.fuelRates || []).map((rate: any, i: number) => (
              <div key={i} className="flex-shrink-0 bg-surface-container-lowest border border-outline-variant/15 p-4 rounded-xl min-w-[140px]">
                <p className="text-xs text-secondary mb-1">{rate.type}</p>
                <p className="text-lg font-bold text-primary">{rate.price} {rate.unit}</p>
              </div>
            ))}
            {(!dashboardData?.fuelRates) && [1, 2, 3].map(i => (
              <div key={i} className="flex-shrink-0 bg-surface-container-lowest border border-outline-variant/15 p-4 rounded-xl min-w-[140px] animate-pulse">
        ...
        <section className="bg-surface-container-lowest rounded-[2rem] p-8 text-center shadow-[0_8px_32px_rgba(0,33,22,0.04)] border border-outline-variant/10">
          <h2 className="text-secondary font-medium mb-6">আজকের অবশিষ্ট লিমিট</h2>
          <div className="relative w-48 h-48 mx-auto flex items-center justify-center">
            <svg className="w-full h-full -rotate-90 transform" viewBox="0 0 100 100">
              <circle cx="50" cy="50" fill="transparent" r="45" stroke="#e8e8e8" strokeWidth="8"></circle>
              <circle 
                cx="50" cy="50" fill="transparent" r="45" stroke="url(#gradient)"
                strokeLinecap="round" strokeWidth="8"
                strokeDasharray="283"
                strokeDashoffset={283 - (283 * ((dashboardData?.limits?.daily?.used || 0) / (dashboardData?.limits?.daily?.total || 1)))}
              ></circle>
              <defs>
            ...
            <div className="absolute flex flex-col items-center">
              <span className="text-4xl font-bold text-primary tracking-tighter">
                {((dashboardData?.limits?.daily?.total || 0) - (dashboardData?.limits?.daily?.used || 0)).toFixed(1)}
              </span>
          ...
          <div className="mt-10 pt-6 border-t border-outline-variant/10 text-left">
            <div className="flex justify-between items-end mb-3">
              <h3 className="text-secondary text-xs font-bold uppercase tracking-widest">এই মাসের মোট কোটা</h3>
              <span className="text-primary font-bold text-sm">
                {dashboardData?.limits?.monthly?.used || 0} / {dashboardData?.limits?.monthly?.total || 0} লিটার
              </span>
            </div>
            <div className="h-3 bg-surface-container-high rounded-full overflow-hidden">
              <div 
                ...
                style={{ width: `${((dashboardData?.limits?.monthly?.used || 0) / (dashboardData?.limits?.monthly?.total || 1)) * 100}%` }}
              ></div>
            </div>
            <p className="text-[10px] text-secondary mt-2 opacity-70">রিনিউয়াল ডেট: {dashboardData?.limits?.monthly?.renewalDate || 'লোডিং...'}</p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="bg-surface-container-low rounded-2xl p-6 flex items-center justify-between border-l-4 border-primary">
            <div>
              <h3 className="text-primary font-bold text-lg">{regModel || 'গাড়ির মডেল'}</h3>
        ...
        <section className="space-y-4">
          <div className="flex justify-between items-center px-1">
            <h2 className="text-secondary text-sm font-bold">সাম্প্রতিক তেল গ্রহণ</h2>
            <button onClick={() => setScreen('transactions')} className="text-primary text-xs font-bold">সব দেখুন</button>
          </div>
          <div className="space-y-4">
            {(dashboardData?.recentTransactions || []).map((item: any, i: number) => (
              ...
              >
                ...
                <div className="flex-1">
                  <p className="text-on-surface font-bold text-base leading-tight">{item.company}</p>
                  <p className="text-secondary text-xs mt-1">{item.date} | {item.amount}</p>
                </div>
                <div className="text-right">
                  <p className="text-primary-container font-bold text-sm">{item.method}</p>
                  <span className="text-[10px] bg-primary-fixed text-on-primary-fixed-variant px-2 py-0.5 rounded-full font-bold">পরিশোধিত</span>
                </div>
              </div>
            ))}
            {(!dashboardData?.recentTransactions) && [1, 2, 3].map(i => (
              <div key={i} className="bg-surface-container-lowest p-5 rounded-2xl flex items-center gap-4 animate-pulse">
      ...
      <nav className="fixed bottom-0 w-full z-50 rounded-t-2xl bg-[#f9f9f9] border-t border-[#bec9c2]/15 shadow-[0_-4px_16px_rgba(0,33,22,0.04)] max-w-md mx-auto left-0 right-0">
        <div className="flex justify-around items-center pt-3 pb-6 px-4 w-full">
          ...
          >
            <History size={24} />
            <span className="text-[12px] font-medium leading-tight">লেনদেন</span>
          </button>
          <button 
          ...
          >
            <MapPin size={24} />
            <span className="text-[12px] font-medium leading-tight">পাম্প ম্যাপ</span>
          </button>
          <button 
          ...
          >
            <User size={24} />
            <span className="text-[12px] font-medium leading-tight">প্রোফাইল</span>
          </button>
        </div>
      </nav>
          ...
          >
            ...
            >
              ...
              <div className="mb-8 mt-4">
                <h2 className="text-2xl font-bold text-primary mb-2">আপনার ফুয়েল পাস QR</h2>
                <p className="text-secondary text-sm">তেল নিতে পাম্প অপারেটরকে এই কোডটি দেখান</p>
              </div>
              ...
              <div className="space-y-4">
                <div className="bg-surface-container-low p-4 rounded-2xl border border-outline-variant/10">
                  <p className="text-xs text-secondary uppercase tracking-widest font-bold mb-1">গাড়ির নম্বর</p>
                  <p className="text-xl font-bold text-on-surface">{regDistrict}-{regSeries} {regNumber}</p>
                </div>
  ...
  const renderTransactions = () => (
    <div className="bg-surface text-on-surface font-body leading-relaxed antialiased min-h-screen">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md flex items-center px-6 py-4 w-full max-w-md mx-auto left-0 right-0 border-b border-[#bec9c2]/15">
        <button onClick={() => setScreen('dashboard')} className="p-2 rounded-full hover:bg-[#eeeeee] text-[#00503a] mr-2">
          <ArrowLeft size={24} />
        </button>
        <h1 className="text-[#00503a] font-bold text-xl tracking-tight">লেনদেনের ইতিহাস</h1>
      </header>
      ...
      <main className="pt-24 pb-32 px-5 max-w-md mx-auto space-y-6">
        <div className="bg-primary-fixed/20 p-6 rounded-2xl flex items-center justify-between border border-primary/10">
          <div>
            <p className="text-secondary text-xs font-bold uppercase tracking-widest mb-1">মোট খরচ (এই মাস)</p>
          ...
          {(dashboardData?.recentTransactions || []).map((item: any, i: number) => (
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div className="flex-1">
                  <p className="text-on-surface font-bold text-lg leading-tight">{item.company}</p>
                  <p className="text-secondary text-xs mt-1">{item.date} • {item.time}</p>
                </div>
                <div className="text-right">
                  <p className="text-primary font-bold text-lg">{item.price}</p>
                  <span className="text-[10px] bg-primary-fixed text-on-primary-fixed-variant px-2 py-0.5 rounded-full font-bold">সফল</span>
                </div>
              </div>
              
              <div className="grid grid-cols-2 gap-4 pt-4 border-t border-outline-variant/10">
                <div>
                  <p className="text-secondary text-[10px] uppercase font-bold tracking-widest mb-1">পরিমাণ</p>
                  <p className="text-sm font-semibold">{item.amount}</p>
                </div>
                <div>
                  <p className="text-secondary text-[10px] uppercase font-bold tracking-widest mb-1">পেমেন্ট পদ্ধতি</p>
                  <p className="text-sm font-semibold">{item.method}</p>
                </div>
                <div className="col-span-2">
                  <p className="text-secondary text-[10px] uppercase font-bold tracking-widest mb-1">অবস্থান</p>
  ...
  const renderProfile = () => (
    <div className="bg-surface text-on-surface font-body leading-relaxed antialiased min-h-screen">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md flex items-center px-6 py-4 w-full max-w-md mx-auto left-0 right-0 border-b border-[#bec9c2]/15">
        ...
        <h1 className="text-[#00503a] font-bold text-xl tracking-tight">প্রোফাইল</h1>
      </header>
      ...
      <main className="pt-24 pb-32 px-5 max-w-md mx-auto space-y-6">
        ...
        <div className="space-y-6">
          <section>
            <h3 className="text-secondary text-xs font-bold uppercase tracking-widest mb-3 px-1">ব্যক্তিগত তথ্য</h3>
            <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden">
              <div className="p-4 flex items-center gap-4 border-b border-outline-variant/5">
                ...
                <div>
                  <p className="text-[10px] text-secondary font-bold uppercase tracking-tighter">নাম</p>
              ...
              <div className="p-4 flex items-center gap-4 border-b border-outline-variant/5">
                ...
                <div>
                  <p className="text-[10px] text-secondary font-bold uppercase tracking-tighter">মোবাইল নম্বর</p>
              ...
              <div className="p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] text-secondary font-bold uppercase tracking-tighter">ইমেইল</p>
                  <p className="text-sm font-semibold">{email || 'দেওয়া হয়নি'}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            <h3 className="text-secondary text-xs font-bold uppercase tracking-widest mb-3 px-1">গাড়ির তথ্য</h3>
            <div className="bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden">
              <div className="p-4 flex items-center gap-4 border-b border-outline-variant/5">
                <div className="w-10 h-10 bg-surface-container rounded-xl flex items-center justify-center text-secondary">
                  <Car size={20} />
                ...
                <div>
                  <p className="text-[10px] text-secondary font-bold uppercase tracking-tighter">গাড়ির ধরন ও মডেল</p>
                  <p className="text-sm font-semibold">
                    {vehicleType === 'bike' ? 'মোটরসাইকেল' : vehicleType === 'car' ? 'কার (ব্যক্তিগত)' : 'ট্রাক'} - {regModel}
                  </p>
                </div>
              </div>
              <div className="p-4 flex items-center gap-4">
                ...
                <div>
                  <p className="text-[10px] text-secondary font-bold uppercase tracking-tighter">নম্বর প্লেট</p>
                  <p className="text-sm font-semibold">{regDistrict}-{regSeries} {regNumber}</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section>
            <h3 className="text-secondary text-xs font-bold uppercase tracking-widest mb-3 px-1">সংযুক্ত নথিপত্র</h3>
            <div className="grid grid-cols-3 gap-3">
              <div className="aspect-square bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden relative group">
                {capturedImages.car ? (
                  <img src={capturedImages.car} className="w-full h-full object-cover" />
                ) : (
                ...
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <span className="text-white text-[10px] font-bold">দেখুন</span>
                </div>
              </div>
              <div className="aspect-square bg-surface-container-lowest rounded-2xl border border-outline-variant/10 overflow-hidden relative group">
                {capturedImages.plate ? (
                  ...
                  <div className="w-full h-full flex flex-col items-center justify-center text-secondary/40">
                    <Hash size={24} />
                    <span className="text-[8px] mt-1 font-bold">নম্বর প্লেট</span>
                  </div>
                )}
                <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <span className="text-white text-[10px] font-bold">দেখুন</span>
    ...
    <div className="bg-surface text-on-surface min-h-screen flex flex-col pb-32">
      ...
      <header className="fixed top-0 left-0 w-full flex justify-between items-center px-6 h-16 bg-white/90 backdrop-blur-md z-50 border-b border-outline-variant/15">
        <div className="flex items-center gap-4">
          ...
          <h1 className="text-lg font-bold text-primary tracking-tight">অপারেটর ড্যাশবোর্ড</h1>
        </div>
        <div className="flex items-center gap-3">
          <button onClick={() => setScreen('profile')} className="w-10 h-10 rounded-full bg-primary-fixed flex items-center justify-center overflow-hidden border-2 border-primary/20 hover:scale-105 active:scale-95 transition-all">
            <img 
      ...
      <main className="pt-20 px-4 max-w-5xl mx-auto space-y-6 flex-grow">
        ...
        <section className="relative overflow-hidden rounded-[2.5rem] bg-slate-950 aspect-square max-w-sm mx-auto md:aspect-video md:max-w-none shadow-2xl border-4 border-surface-container-lowest group cursor-pointer">
          ...
          <div className="absolute inset-0 bg-[#0a0a0a]">
            <div className="absolute inset-0 opacity-10" style={{ backgroundImage: 'radial-gradient(circle, #9ef4d0 1px, transparent 1px)', backgroundSize: '40px 40px' }}></div>
          ...
          <div className="absolute bottom-0 left-0 w-full bg-primary/90 backdrop-blur-xl py-5 px-8 flex items-center justify-center gap-4">
            ...
            <p className="text-white text-lg font-black tracking-wider uppercase">গ্রাহকের কিউআর কোড স্ক্যান করুন</p>
          </div>
        </section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <section className="md:col-span-2 space-y-6">
                ...
                <div className="flex flex-col items-center">
                  <div className="relative w-36 h-36 flex items-center justify-center">
                    <svg className="w-full h-full transform -rotate-90">
                      <circle className="text-surface-container-high" cx="72" cy="72" fill="transparent" r="64" stroke="currentColor" strokeWidth="12"></circle>
                      <circle className="text-primary" cx="72" cy="72" fill="transparent" r="64" stroke="currentColor" strokeDasharray="402" strokeDashoffset="100.5" strokeWidth="12" strokeLinecap="round"></circle>
                    </svg>
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-3xl font-black text-on-surface">৭৫%</span>
                    </div>
                  </div>
                  <h3 className="mt-5 font-bold text-secondary tracking-wide uppercase text-xs">অকটেন স্টক</h3>
                  <p className="text-sm font-bold text-on-surface mt-1">১৫,০০০ / ২০,০০০ লিটার</p>
                </div>
                {/* Diesel Gauge (Alert) */}
                <div className="flex flex-col items-center">
                  <div className="relative w-36 h-36 flex items-center justify-center">
                    <svg className="w-full h-full transform -rotate-90">
                      <circle className="text-surface-container-high" cx="72" cy="72" fill="transparent" r="64" stroke="currentColor" strokeWidth="12"></circle>
                      <circle className="text-error" cx="72" cy="72" fill="transparent" r="64" stroke="currentColor" strokeDasharray="402" strokeDashoffset="361.8" strokeWidth="12" strokeLinecap="round"></circle>
                    </svg>
                    <div className="absolute inset-0 flex flex-col items-center justify-center">
                      <span className="text-3xl font-black text-error">১০%</span>
                    </div>
                  </div>
                  <h3 className="mt-5 font-bold text-error tracking-wide uppercase text-xs">ডিজেল স্টক</h3>
                  <p className="text-sm font-bold text-error mt-1">২,০০০ / ২০,০০০ লিটার</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-surface-container-lowest p-8 rounded-[2rem] shadow-sm border border-outline-variant/10">
              <h2 className="text-xl font-bold text-primary mb-8">শিফট সামারি</h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="p-5 bg-surface-container-low rounded-2xl flex items-center gap-5 border border-outline-variant/5">
                  ...
                  <div>
                    <p className="text-[10px] text-secondary font-bold uppercase tracking-widest">মোট ট্রানজ্যাকশন</p>
                    <p className="text-xl font-black text-on-surface">১২৪ টি গাড়ি</p>
                  </div>
                </div>
                <div className="p-5 bg-surface-container-low rounded-2xl flex items-center gap-5 border border-outline-variant/5">
                  <div className="w-12 h-12 bg-primary-fixed rounded-xl flex items-center justify-center text-primary shadow-sm shadow-primary/10">
                  ...
                  <div>
                    <p className="text-[10px] text-secondary font-bold uppercase tracking-widest">মোট তেল বিক্রয়</p>
                    <p className="text-xl font-black text-on-surface">৮৫০.৫ লিটার</p>
                  </div>
                </div>
                <div className="p-5 bg-surface-container-low rounded-2xl flex items-center gap-5 border border-outline-variant/5">
                  <div className="w-12 h-12 bg-primary-fixed rounded-xl flex items-center justify-center text-primary shadow-sm shadow-primary/10">
                  ...
                  <div>
                    <p className="text-[10px] text-secondary font-bold uppercase tracking-widest">মোট ক্যাশ কালেকশন</p>
                    <p className="text-xl font-black text-on-surface">১,১৫,৫০০ টাকা</p>
                  </div>
                </div>
                <div className="p-5 bg-error/5 rounded-2xl flex items-center gap-5 border border-error/10">
                  ...
                  <div>
                    <p className="text-[10px] text-error font-bold uppercase tracking-widest">জালিয়াতি এলার্ট</p>
                    <p className="text-xl font-black text-error text-balance">০২ টি Mismatch</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <aside className="space-y-6">
              ...
              <div className="p-8 space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center py-1 border-b border-outline-variant/10">
                    <span className="text-secondary text-xs font-bold uppercase tracking-tighter">গাড়ির প্রোফাইল</span>
                    <span className="text-primary font-black text-sm">আসল রেকর্ড</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary text-sm font-medium">মডেল</span>
                    <span className="text-on-surface font-black">Toyota Premio</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary text-sm font-medium">রঙ</span>
            ...
            <div className="bg-primary/5 rounded-[2rem] p-6 border border-primary/10">
               <h4 className="text-primary font-bold text-sm mb-4">কুইক অ্যাকশন</h4>
               <div className="grid grid-cols-2 gap-3">
                  <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-2xl border border-primary/5 shadow-sm active:scale-95 transition-all">
                    ...
                    <span className="text-[10px] font-bold text-secondary uppercase">ম্যানুয়াল স্ক্যান</span>
                  </button>
                  <button className="flex flex-col items-center gap-2 p-4 bg-white rounded-2xl border border-primary/5 shadow-sm active:scale-95 transition-all">
                    <Settings className="text-primary" size={24} />
                    <span className="text-[10px] font-bold text-secondary uppercase">পাম্প সেটিংস</span>
                  </button>
               </div>
            </div>
          </aside>
      ...
      <button className="fixed bottom-28 right-6 bg-primary text-on-primary py-4 px-8 rounded-full shadow-[0_20px_40px_rgba(0,80,58,0.3)] flex items-center gap-4 active:scale-95 transition-all z-40 border border-white/20 group">
        ...
        <span className="font-black text-lg tracking-tight">তেল প্রদান ইনপুট</span>
      </button>
      ...
      <nav className="fixed bottom-0 left-0 w-full z-50 flex justify-around items-center px-4 pb-10 bg-white/95 backdrop-blur-md h-24 border-t border-outline-variant/10 shadow-[0_-10px_30px_rgba(0,0,0,0.03)] font-body">
        <button onClick={() => setScreen('dashboard')} className="flex flex-col items-center justify-center text-primary pt-2 pb-1 relative group">
        ...
        <button onClick={() => setScreen('transactions')} className="flex flex-col items-center justify-center text-secondary pt-2 pb-1 hover:text-primary transition-all">
          <History size={28} />
        ...
        <button onClick={() => setScreen('profile')} className="flex flex-col items-center justify-center text-secondary pt-2 pb-1 hover:text-primary transition-all">
          <Settings size={28} />
  ...
  const renderNotifications = () => (
    <div className="bg-surface text-on-surface font-body leading-relaxed antialiased min-h-screen">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md flex items-center px-6 py-4 w-full max-w-md mx-auto left-0 right-0 border-b border-[#bec9c2]/15">
        ...
        <h1 className="text-[#00503a] font-bold text-xl tracking-tight">নোটিফিকেশন</h1>
      </header>
      ...
      <main className="pt-24 pb-32 px-5 max-w-md mx-auto space-y-4">
        {notifications.length > 0 ? (
              ...
              >
                <div className="flex gap-4">
                  <div className={`w-12 h-12 rounded-full flex items-center justify-center shrink-0 ${
                    ...
                    notif.type === 'security' ? 'bg-purple-100 text-purple-600' :
                    'bg-primary-fixed/30 text-primary'
                  }`}>
                    {notif.type === 'success' ? <Fuel size={24} /> :
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start mb-1">
                      <h3 className={`font-bold text-base ${notif.unread ? 'text-primary' : 'text-on-surface'}`}>{notif.title}</h3>
                      <span className="text-[10px] text-secondary font-medium whitespace-nowrap ml-2">{notif.time}</span>
                    </div>
                    <p className="text-sm text-secondary leading-snug">{notif.message}</p>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="flex flex-col items-center justify-center pt-20 text-center">
            ...
            <h3 className="text-lg font-bold text-secondary">কোন নোটিফিকেশন নেই</h3>
            <p className="text-sm text-secondary/60">আপনার সব নোটিফিকেশন এখানে দেখা যাবে</p>
          </div>
        )}
      </main>
  ...
  const renderMap = () => (
    <div className="bg-surface text-on-surface font-body leading-relaxed antialiased min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9]/80 backdrop-blur-md flex items-center px-6 py-4 w-full max-w-md mx-auto left-0 right-0 border-b border-[#bec9c2]/15">
        ...
        <h1 className="text-[#00503a] font-bold text-xl tracking-tight">নিকটস্থ পাম্প</h1>
      </header>

      <main className="flex-1 relative pt-16 pb-24 overflow-hidden">
        {/* Simulated Map Background */}
        <div className="absolute inset-0 bg-[#e5e7eb] overflow-hidden">
          <div className="absolute inset-0 opacity-20" style={{ backgroundImage: 'radial-gradient(#00503a 1px, transparent 1px)', backgroundSize: '20px 20px' }}></div>
          ...
          {pumps.map((pump) => (
            ...
            >
              <div className={`relative flex flex-col items-center`}>
                <div className={`p-2 rounded-full shadow-lg border-2 border-white ${pump.status === 'বন্ধ' ? 'bg-red-500' : pump.status === 'ভিড় বেশি' ? 'bg-orange-500' : 'bg-primary'}`}>
                  <Fuel size={20} className="text-white" />
                </div>
                <div className="mt-1 px-2 py-0.5 bg-white/90 backdrop-blur-sm rounded-md shadow-sm border border-outline-variant/20">
                  <span className="text-[10px] font-bold whitespace-nowrap">{pump.distance}</span>
                </div>
              </div>
            </button>
          ))}
            ...
            >
              <div className="bg-surface-container-lowest p-5 rounded-[2rem] shadow-2xl border border-outline-variant/15">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-lg font-bold text-primary">{selectedPump.name}</h3>
                ...
                <div className="grid grid-cols-3 gap-2 mb-4">
                  <div className={`p-2 rounded-xl border flex flex-col items-center ${selectedPump.octane === 'আছে' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100'}`}>
                    <span className="text-[10px] font-bold text-secondary uppercase">অকটেন</span>
                    <span className={`text-xs font-bold ${selectedPump.octane === 'আছে' ? 'text-green-700' : 'text-red-700'}`}>{selectedPump.octane}</span>
                  </div>
                  <div className={`p-2 rounded-xl border flex flex-col items-center ${selectedPump.diesel === 'আছে' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100'}`}>
                    <span className="text-[10px] font-bold text-secondary uppercase">ডিজেল</span>
                    <span className={`text-xs font-bold ${selectedPump.diesel === 'আছে' ? 'text-green-700' : 'text-red-700'}`}>{selectedPump.diesel}</span>
                  </div>
                  <div className={`p-2 rounded-xl border flex flex-col items-center ${selectedPump.petrol === 'আছে' ? 'bg-green-50 border-green-100' : 'bg-red-50 border-red-100'}`}>
                    <span className="text-[10px] font-bold text-secondary uppercase">পেট্রোল</span>
                    <span className={`text-xs font-bold ${selectedPump.petrol === 'আছে' ? 'text-green-700' : 'text-red-700'}`}>{selectedPump.petrol}</span>
                  </div>
                </div>
  ...
  const renderLogin = () => (
    <div className="bg-surface text-on-surface min-h-screen flex flex-col">
      <header className="fixed top-0 w-full z-50 bg-[#f9f9f9] backdrop-blur-md border-b border-[#bec9c2]/15 h-16 flex items-center justify-between px-6">
        <div className="flex items-center gap-4">
          <button onClick={() => setScreen('splash')} className="text-[#00503a] active:scale-95 duration-200 p-2 hover:bg-[#eeeeee] rounded-full transition-colors">
            <ArrowLeft size={24} />
          </button>
      ...
      <main className="flex-grow pt-24 pb-12 px-6 max-w-md mx-auto w-full">
        <div className="flex flex-col gap-8">
          <div className="text-center">
            ...
            <h2 className="text-2xl font-bold text-on-surface">ফিরে আসায় স্বাগতম</h2>
          ...
          <div className="flex bg-surface-container-high p-1 rounded-2xl">
            <button 
              ...
              className={`flex-1 py-3 rounded-xl font-bold text-sm transition-all ${userRole === 'owner' ? 'bg-primary text-on-primary shadow-md' : 'text-secondary'}`}
            >
              যানবাহন মালিক
            </button>
            <button 
              onClick={() => setUserRole('operator')}
              className={`flex-1 py-3 rounded-xl font-bold text-sm transition-all ${userRole === 'operator' ? 'bg-primary text-on-primary shadow-md' : 'text-secondary'}`}
            >
              পাম্প অপারেটর
            </button>
          </div>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                <label htmlFor="login-mobile" className="text-xs font-bold text-secondary uppercase tracking-widest ml-1">মোবাইল নম্বর</label>
                <div className="relative">
                  <Smartphone className="absolute left-4 top-1/2 -translate-y-1/2 text-primary" size={20} />
                  <input 
                    id="login-mobile"
                    name="mobileNumber"
                    type="tel"
              ...
              <div className="space-y-2">
                <label htmlFor="login-password" className="text-xs font-bold text-secondary uppercase tracking-widest ml-1">পাসওয়ার্ড</label>
                <div className="relative">
                  <ShieldCheck className="absolute left-4 top-1/2 -translate-y-1/2 text-primary" size={20} />
                  <input 
                    id="login-password"
    ...
    <div className="min-h-screen font-body">
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {screen === 'dashboard' && (userRoleActual === 'operator' ? renderOperatorDashboard() : renderDashboard())}
          ...
          >
            ...
            >
              ...
              <div className="flex justify-between items-start mb-8">
                <div>
                  <h2 className="text-2xl font-bold text-primary mb-1">লেনদেনের রিসিট</h2>
                  <p className="text-secondary text-sm">ID: #FP-{Math.floor(100000 + (Math.random() * 900000))}</p>
                </div>
                <button 
                  onClick={() => setSelectedTransaction(null)}
              ...
              <div className="bg-surface-container-low rounded-3xl p-6 border border-outline-variant/10 mb-8">
                <div className="flex flex-col items-center mb-6 pb-6 border-b border-outline-variant/10 text-center">
                  ...
                  <h3 className="text-xl font-bold text-on-surface">{selectedTransaction.company}</h3>
                  <p className="text-sm text-secondary">{selectedTransaction.location}</p>
                </div>

                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    <span className="text-secondary text-sm">তারিখ ও সময়</span>
                    <span className="font-bold text-on-surface">{selectedTransaction.date} | {selectedTransaction.time || '১১:৪৫ AM'}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary text-sm">তেলের পরিমাণ</span>
                    <span className="font-bold text-on-surface">{selectedTransaction.amount}</span>
                  </div>
                  <div className="flex justify-between items-center">
                    <span className="text-secondary text-sm">পেমেন্ট পদ্ধতি</span>
                    <span className="font-bold text-on-surface">{selectedTransaction.method}</span>
                  </div>
                  <div className="pt-4 mt-4 border-t border-dashed border-outline-variant/30 flex justify-between items-center">
                    <span className="text-on-surface font-bold text-lg">মোট বিল</span>
                    <span className="text-primary font-black text-2xl">{selectedTransaction.price || '৪৫০.০০ টাকা'}</span>
                  </div>
                </div>
              </div>
